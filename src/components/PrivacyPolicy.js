...
This privacy policy sets out how Linck One Enterprises uses and protects any information that you give Linck One Enterprises when you use this website.

Linck One Enterprises is committed to ensuring that your privacy is protected. Should we ask you to provide certain information by which you can be identified when using this website, and then you can be assured that it will only be used in accordance with this privacy statement.

Linck One Enterprises may change this policy from time to time by updating this page. You should check this page from time to time to ensure that you are happy with any changes.
        </p>
    </div>
